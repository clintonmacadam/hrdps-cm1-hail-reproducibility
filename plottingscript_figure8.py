...
for i in range(7,36):
    ...
    plt.figlegend(['MAX=12'], bbox_to_anchor=(-0.29, 0.2495, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    plt.figlegend(['MAX=18'], bbox_to_anchor=(0.1935, 0.2495, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    plt.figlegend(['MAX=0.9'], bbox_to_anchor=(-0.2835, -0.073, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    plt.figlegend(['MAX=0.9'], bbox_to_anchor=(0.2, -0.073, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    plt.figlegend(['MAX=25'], bbox_to_anchor=(-0.29, -0.397, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    plt.figlegend(['MAX=28'], bbox_to_anchor=(0.1935, -0.397, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    ...
    plt.figlegend(['v3'], bbox_to_anchor=(-0.0725, 0.475, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    plt.figlegend(['2MOM'], bbox_to_anchor=(0.41, 0.475, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    plt.figlegend(['v3'], bbox_to_anchor=(-0.0725, 0.153, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    plt.figlegend(['2MOM'], bbox_to_anchor=(0.41, 0.153, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    plt.figlegend(['v3'], bbox_to_anchor=(-0.0725, -0.17, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    plt.figlegend(['2MOM'], bbox_to_anchor=(0.41, -0.17, 0.5, 0.5), fontsize=28, handlelength=0, handletextpad=0)
    fig.tight_layout()
...
images[0].save(''+ date +'/hailswathloop_groundrelative_2panel_2500m_comparemphrdpsmp50_'+date+'.gif', save_all=True, append_images=images[1:], duration=600, loop=0)
